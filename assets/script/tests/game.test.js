...
describe("Gameplay works correctly", () => {
    ...
    test("should increment the score if the turm is correct", () => {
    ...
    test("should toggle turnInProcess to true", () => {
        showTurns();
        expect(game.turnInProgress).toBe(true);
    });
    test("clicking during the comeputers sequence should fail", () => {
        showTurns();
        game.lastButton = "";
